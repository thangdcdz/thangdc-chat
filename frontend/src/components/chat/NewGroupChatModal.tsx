...
const NewGroupChatModal = () => {
  ...
  const hanhdleGetFriends = async () => {
    await getFriends();
  };

  const hanhdleSelectFriend = (friend: Friend) => {
    setInvitedUsers([...invitedUsers, friend]);
    setSearch("");
  };

  const hanhdleRemoveFriend = (friend: Friend) => {
          ...
          <div className="space-y-2">
            ...
            {search && filteredFriends.length > 0 && (
              <InviteSuggestionList
                ...
                onSelect={hanhdleSelectFriend}
              />
            )}

            <SelectedUsersList
              invitedUsers={invitedUsers}
              onRemove={hanhdleRemoveFriend}
            />
          </div>
